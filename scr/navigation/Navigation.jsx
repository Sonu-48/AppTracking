    ...
    return (
        <Stack.Navigator initialRouteName="SplachScreen">
            ...
            />
             ...
             <Stack.Screen name="Credits" component={CreditsPage} options={{headerShown:true}}/>
             <Stack.Screen name="Tutorials" component={TutorialsPage} options={{headerShown:true}}/>
             <Stack.Screen name="Tips" component={TipsPage} options={{headerShown:true}}/>
        </Stack.Navigator>
    );
};
